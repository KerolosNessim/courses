      ...
      <main>
        ...
        <section className='  pt-30'>
          ...
          <div className='container'>
            <CustomBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Courses', href: '/courses' }, { label: 'Human Anatomy Basics – 6 hours' }]} />
          </div>
          {/* details */}
            ...
            <div className="container flex items-center gap-8 max-lg:flex-col-reverse">
              ...
              <motion.div
                ...
                <div className='flex items-center gap-2'>
                  ...
                  <div className="bg-main-navy p-2 text-white rounded-full text-xs font-semibold flex w-fit items-center gap-2 ">
                    <span className="px-2 py-1 text-main-navy bg-white rounded-full">
                      <RxLapTimer size={16} fill='#325d7b' />
                    </span>
                    <p>06h & 48 min</p>
                  </div>
                ...
                {/* tilte */}
                <h1 className='lg:text-4xl text-3xl text-main-orange font-bold lg:leading-16'>Human Anatomy Basics <br className='max-lg:hidden' /> – 6 Hours.</h1>
                {/* description */}
                <p className='font-semibold lg:leading-loose'>Explore the world of bacteria and viruses, and learn essential laboratory examination techniques.</p>
                {/* rate */}
                <div>
                ...
                {/* price */}
                <p className='lg:text-4xl text-3xl font-bold text-main-orange'>$39.99</p>
                {/* buy and add to cart */}
                <div className='flex items-center gap-2'>
              ...
              <motion.div
                ...
                transition={{ duration: 0.7 }}
                className='lg:w-1/2'>
                <Image src="/home/course-img.jpg" alt="course" width={500} height={500} className="w-full rounded-[50px]" />
              </motion.div>
