...
const CoursesCard = () => {
  return (
    <div className='lg:space-y-4 space-y-2'>
      {/* image */}
      <div className=' lg:h-[18rem] h-[16rem] bg-[url("/home/course-img.jpg")] bg-cover bg-center rounded-[50px] overflow-hidden'>
      ...
      <div className='space-y-3'>
        ...
        {/* title */}
        <h3 className='text-lg font-bold text-main-orange'>Human Anatomy Basics – 6 hours</h3>
        {/* description */}
        <p className='text-sm  text-main-navy'>Learn the fundamentals of human anatomy in a simple way with clear practical examples.</p>
        {/* price */}
