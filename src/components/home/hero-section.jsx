      ...
      <div className=" bg-[url('/home/bg-squares.svg')] bg-cover bg-center">
        ...
        <div className="container   min-h-screen flex items-center ">
          ...
          <motion.div
            ...
            {/* courses link */}
            <Link href="/" className="group max-lg:mx-auto bg-main-light-orange ps-6 pe-2 py-2 text-white rounded-full text-sm font-semibold flex w-fit items-center gap-6">
              Discover courses
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.7 , delay:0.7}}
            className="hidden lg:block relative w-1/2  bg-[url('/home/hero-bg.svg')] bg-contain bg-bottom bg-no-repeat min-h-screen ">
