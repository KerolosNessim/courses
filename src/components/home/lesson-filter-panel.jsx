...
const LessonFilterPanel = () => {
  const panel = (
    <div className='p-6 bg-main-bg-gray rounded-[30px] space-y-4 w-full'>
      ...
      {/* support */}
      <a href="#" className="mt-6 text-xs font-semibold text-main-navy flex items-center justify-center gap-1 hover:gap-2 transition-all duration-300"><HiOutlineEnvelope size={16} />support@info.com</a>
        ...
        <Sheet>
          ...
          <SheetContent side="bottom" className="rounded-t-3xl p-0 max-h-[80vh] overflow-y-auto">
            <SheetHeader className="p-6">
              <SheetTitle className="text-main-orange">Book one-on-one learning sessions with the doctor to quickly develop your medical skills and get precise answers to your questions.</SheetTitle>
            </SheetHeader>
            {panel}
          </SheetContent>
        </Sheet>
